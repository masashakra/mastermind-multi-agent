#!/usr/bin/env python3
"""
Aggregate and report on all round-table semantic analyses.
"""
...
def load_analyses(logs_dir):
    ...
    print(f"Found {len(analysis_files)} round-table analysis files")
...
def print_report(analyses, stats):
    ...
    print("\n" + "="*80)
    print("  ROUND-TABLE SEMANTIC ANALYSIS AGGREGATE REPORT")
    print("="*80)

    print(f"\nCOVERAGE:")
    print(f"  Analyzed puzzles: {stats['num_puzzles']}")
...
def main():
    ...
    out_path = "logs/round_table_semantic_analysis_aggregate.json"
