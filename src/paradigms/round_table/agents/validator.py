...
AGENT_CARD = {
    **VALIDATOR_CARD,
    "agent_id": "validator_round_table",
...
class ValidatorAgent(BaseAgent):
    ...
    def __init__(self, provider: str = "ollama", comm_layer: Optional[A2ACommunicationLayer] = None,
        ...
        super().__init__(
            name="Validator_RoundTable", provider=provider, comm_layer=comm_layer,
            role=role or AgentRole.VALIDATOR, paradigm=paradigm or ParadigmType.ROUND_TABLE,
            team_members=team_members or ["analyzer", "strategist", "proposer"],
