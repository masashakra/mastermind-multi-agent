#!/usr/bin/env python3
"""Test to see agent reasoning after round 1"""
...
# After round 1: guess = ['red', 'blue', 'green', 'yellow'], feedback = 1 peg, 0 positions
...
print("=" * 70)
print("Testing Agent Reasoning for Mastermind Round 2 (after round 1)")
print("=" * 70)
print("\nGuess History:")
...
# Step 2: Analyzer
print("\n" + "=" * 70)
print("STEP 2: ANALYZER (analyzing round 1 feedback)")
print("=" * 70)
...
# Step 3: Proposer
print("\n" + "=" * 70)
print("STEP 3: PROPOSER (proposing round 2 guess)")
print("=" * 70)
