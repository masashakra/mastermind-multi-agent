#!/usr/bin/env python3
"""Test Direct Debate paradigm on puzzles."""
...
print("=" * 70)
print("Coopetition: 3 teams, unmoderated peer debate")
print()
...
for difficulty, puzzle in test_puzzles.items():
    ...
    try:
        orchestrator = DirectDebateOrchestrator(puzzle, provider="kaggle")
        ...
        print(f"  Debate rounds: {coop_stats.get('debate_rounds', 0)}")
...
print("\nNote: Direct Debate = 3 teams with unmoderated peer discussion")
