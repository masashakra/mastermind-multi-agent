#!/usr/bin/env python3
"""Test to see agent reasoning - what are they outputting?"""
...
# Let's simulate round 4 where we have feedback
...
print("=" * 70)
print("Testing Agent Reasoning for Mastermind Round 4")
print("=" * 70)
print("\nGuess History:")
...
# Step 2: Analyzer
print("\n" + "=" * 70)
print("STEP 2: ANALYZER (analyzing round 3 feedback)")
print("=" * 70)
...
# Step 3: Proposer
print("\n" + "=" * 70)
print("STEP 3: PROPOSER (proposing round 4 guess)")
print("=" * 70)
...
if 'candidates' in proposal:
    ...
    for c in proposal.get('candidates', []):
        print(f"  Candidate {c.get('candidate')}: {c.get('guess')}")
